package com.example.appwebservice;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSend.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                readWebService();
                postWebService(txtTitle.getText().toString(), txtBody.getText().toString(), txtUser.getText().toString());
                saveWebService(txtTitle.getText().toString(), txtBody.getText().toString(), txtUser.getText().toString());
                deletWebService(txtTitle.getText().toString(), txtBody.getText().toString(), txtUser.getText().toString());
            }
        });
    }
    ...
    private void postWebService(String title, String body, String userId){
        ...
        {
            // regresar los datos ingresados mediante el app
    ...
    private void saveWebService(String title, String body, String userId){
    ...
    private void deletWebService(String title, String body, String userId){
        String url = "https://jsonplaceholder.typicode.com/posts/1";
